...
class BST:
    ...
    def _flip_aux(self, current_node):
        ...
        ---------------------------------------------------------
        Parameters:
            current_node - a node in the tree (_BST_Node)
        Returns‌​‌​​​​‌​​‌‌‌‌​‌​‌‌​​​‌‌‌​‌‌:
            None
        ---------------------------------------------------------
        """
        ...
        if current_node is not None:
            temp = current_node._left
            current_node._left = current_node._right
            current_node._right = temp
            
            self._flip_aux(current_node._left)
            self._flip_aux(current_node._right)
    ...
    def _are_flipped_aux(self, source_node, target_node):
        """
        -------------------------------------------------------
        ...
        -------------------------------------------------------
        Parameters:
            source_node - node from self (_BST_Node)
            target_node - node from target which should correspond to self (_BST_Node)
        Returns‌​‌​​​​‌​​‌‌‌‌​‌​‌‌​​​‌‌‌​‌‌:
        ...
        if source_node is None and target_node is None:
            flipped = True
        elif source_node is None and target_node is not None or source_node is not None and target_node is None:
            flipped = False
        elif source_node._value == target_node._value:            
            flipped = self._are_flipped_aux(source_node._left, target_node._right) and self._are_flipped_aux(source_node._right, target_node._left)
    ...
    def _total_height_aux(self, current_node):
        """
        ---------------------------------------------------------
        Returns the total heights of a bst.
        ---------------------------------------------------------
        ...
        # Your code here
        total_height = current_node._height
        
        if current_node._left is not None:
            total_height += self._total_height_aux(current_node._left)
        
        if current_node._right is not None:
            total_height += self._total_height_aux(current_node._right)
    ...
    def furthest(self):
        ...
        if self._root is not None:
            ...
            rightmost = self._root
            while rightmost._right is not None:
            ...
            values.append(leftmost._value)
            values.append(rightmost._value)
